...
const GeneralFooter = () => {
  return (
    <div className=' flex max-lg:flex-col-reverse max-lg:divide-y bg-white divide-x divide-gray-300 text-black min-h-fit'>
      ...
      <div className='hidden max-lg:flex justify-between items-center px-5 py-7'>
        <div className='max-md:ml-auto max-md:mr-auto'>© 2022. Special Painting LLC All Rights Reserved.</div>
      ...
      <div className='flex flex-col items-start justify-between py-7 px-8 w-full'>
        ...
        <div className='text-7xl text-bold max-lg:ml-auto max-lg:mr-auto max-lg:my-10'>Vention</div>
      </div>
      <div className='flex flex-col justify-around min-h-[17rem] items-center min-w-[40vw] '>
        ...
        <div className='max-lg:hidden'>© 2022. Special Painting LLC All Rights Reserved.</div>
      </div>
    </div>
  )
}
